	...
	public IndexedModel toIndexedModel()
	{
		...
		for(int i = 0; i < indices.size(); i++)
		{
			...
			if(modelVertexIndex == null)
			{
				...
				resultIndexMap.put(currentIndex, modelVertexIndex);	//size is the same as counter
			...
			if(normalModelIndex == null)
			{
				...
				normalIndexMap.put(currentIndex.vertexIndex, normalModelIndex);	//size is the same as counter
